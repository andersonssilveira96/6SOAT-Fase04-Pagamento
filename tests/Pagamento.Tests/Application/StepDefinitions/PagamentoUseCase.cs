...
public class PagamentoUseCaseSteps
{
    ...
    [Given(@"existe um pagamento com o n�mero de pedido ""(.*)""")]
    ...
    [Given(@"não existe um pagamento com o n�mero de pedido ""(.*)""")]
    ...
    [Given(@"o servi�o de gateway retorna um pagamento para o pedido ""(.*)"" com valor ""(.*)""")]
    ...
    [Then(@"uma mensagem deve ser enviada para o t�pico ""(.*)""")]
    ...
    [Then(@"deve ser lançada uma exce��o com a mensagem ""(.*)""")]
